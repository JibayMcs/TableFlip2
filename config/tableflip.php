...
return [
    ...
    'auth' => [
        // When false (default), the login lets the user authenticate
        // against a server WITHOUT picking a database. Switch to true to
        // force the database field to be filled at login.
