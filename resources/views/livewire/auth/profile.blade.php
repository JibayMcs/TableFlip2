<div class="max-w-2xl mx-auto space-y-8">
    ...
    <section class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-6">
        <form wire:submit="saveProfile" class="space-y-4">
            ...
            <div class="grid grid-cols-3 gap-3">
                <div>
                    <label for="timezone" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Timezone</label>
                ...
                <div>
                    <label for="locale" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Locale</label>
                    <input id="locale" type="text" wire:model="locale"
                        class="w-full rounded-md border border-zinc-300 dark:border-zinc-700 px-3 py-2 text-sm" />
                </div>
                <div>
                    <label for="theme" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Theme</label>
    ...
    <section class="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-6">
        <form wire:submit="changePassword" class="space-y-4">
            ...
            <div>
                <label for="currentPassword" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Current password</label>
            ...
            <div>
                <label for="newPassword" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">New password</label>
            ...
            <div>
                <label for="newPasswordConfirmation" class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">Confirm new password</label>
